...
export const menu: RouteMenu[] = [
  ...
  { id: '12', position: 'footer', path: '/carousel', name: 'Carousel', icon: ClubPortalIco, component: 'Carousel', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '13', position: 'footer', path: '/dashboard', name: 'Dashboard', icon: ClubPortalIco, component: 'Dashboard', locale: 'menu.sider.dialog', signedin: false, exact: true },
  { id: '14', position: 'footer', path: '/category', name: 'Dashboard', icon: ClubPortalIco, component: 'Category', locale: 'menu.sider.dialog', signedin: false, exact: true },
  { id: '15', position: 'footer', path: '/search', name: 'Search', icon: ClubPortalIco, component: 'Search', locale: 'menu.sider.dialog', signedin: false, exact: true },
  { id: '16', position: 'footer', path: '/my_page', name: 'MyPage', icon: ClubPortalIco, component: 'MyPage', locale: 'menu.sider.dialog', signedin: false, exact: true },
  { id: '17', position: 'footer', path: '/google_login', name: 'GoogleLogin', icon: ClubPortalIco, component: 'GoogleLogin', locale: 'menu.sider.dialog', signedin: false, exact: true },
  { id: '19', position: 'left', path: '/goods', name: 'Goods', icon: ClubPortalIco, component: 'Goods', locale: 'menu.sider.dialog', signedin: false, exact: true },
  ...
  { id: '30', position: '', path: '/my_page/point_list', name: 'PointList', icon: ClubPortalIco, component: 'PointList', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '31', position: '', path: '/my_page/about', name: 'About', icon: ClubPortalIco, component: 'About', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '32', position: '', path: '/my_page/board_faq', name: 'BoardFaq', icon: ClubPortalIco, component: 'BoardFaq', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '34', position: '', path: '/my_page/board_notice', name: 'BoardNotice', icon: ClubPortalIco, component: 'BoardNotice', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '35', position: '', path: '/my_page/board_qna', name: 'GoogleLogin', icon: ClubPortalIco, component: 'BoardOneToOne', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '36', position: '', path: '/my_page/config_alarm', name: 'ConfigAlarm', icon: ClubPortalIco, component: 'ConfigAlarm', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '37', position: '', path: '/my_page/coupon_list', name: 'CouponList', icon: ClubPortalIco, component: 'CouponList', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '38', position: '', path: '/my_page/goods_comment_list', name: 'GoodsCommentList', icon: ClubPortalIco, component: 'GoodsCommentList', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '39', position: '', path: '/my_page/help_desk', name: 'HelpDesk', icon: ClubPortalIco, component: 'HelpDesk', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '40', position: '', path: '/my_page/order_list', name: 'OrderList', icon: ClubPortalIco, component: 'OrderList', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '41', position: '', path: '/my_page/profile_update', name: 'ProfileUpdate', icon: ClubPortalIco, component: 'ProfileUpdate', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '42', position: '', path: '/my_page/shipping_info', name: 'ShippingInfo', icon: ClubPortalIco, component: 'ShippingInfo', locale: 'menu.sider.carousel', signedin: false, exact: true },
  { id: '43', position: '', path: '/my_page/friend_list', name: 'ShippingInfo', icon: ClubPortalIco, component: 'ShippingInfo', locale: 'menu.sider.carousel', signedin: false, exact: true }
